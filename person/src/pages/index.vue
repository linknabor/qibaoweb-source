...
.footer_temai{background-image: url('../assets/images/common/icon_property.png');}
    ...
    <footer class="footer">
      <nav>
        <ul>
          ...
          <li>
            <a href="https://www.e-shequ.com/qibao/weixin/wuye/index.html?v=20160229" class="nav-controller">
              <i class="footer_logo footer_temai"></i>社区
            </a>
          </li> 
          <!-- <li>
            <a href="https://www.e-shequ.com/dhzj3/weixin/home/index.html?v=20160229" class="nav-controller ">
              <i class="footer_logo footer_wuye_selected"></i>增值
            </a>
          </li> -->
          <li>
            <a href="https://www.e-shequ.com/qibao/weixin/person/index.html?v=20160229" class="nav-controller  active">
