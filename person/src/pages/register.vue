<template>
   <div class="reg">
       ...
       <div id="phoneAjax" class="hidden"  v-show="zzmb">
		    <img src="../assets/images/person/c3d7f369-4a5e-4c4a-9fb9-a4b9d274c7e1.gif" style="width:40px;height40px;vertical-align: middle;">
	   </div>
                 ...
                 if(vm.res.success) {
                        vm.common.updateUserStatus(vm.res.result);
                            ...
                            if(vm.comeFrom){
                                ...
                                forwardPage = "https://www.e-shequ.com/qibao/weixin/person/index.html";
                            }
                            if (page) {
