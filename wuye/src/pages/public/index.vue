        ...
        <div  class="category lite-divider" v-show="threadCategory>=2">
             <div class="category_main">
                 <div  class="category_sub_main fl">
                    <router-link :to="{path:'/publish',query:{category:'2'}}" class="categorya">
                   <img class="category_img" src="../../assets/img/butler/img_repair_60x60.png" v-show="threadCategory!=2"/>
                    <img class="category_img_hide" src="../../assets/img/butler/img_repair_60x60_selected.png" v-show="threadCategory==2"/> 
                    <div class="category_txt">家庭维修</div>
                    </router-link>
                </div>

                <div  class="category_sub_main fl">
                    <router-link :to="{path:'/publish',query:{category:'3'}}" class="categorya">
                    <img class="category_img" src="../../assets/img/butler/img_education_60x60.png" v-show="threadCategory!=3"/>
                    <img class="category_img_hide" src="../../assets/img/butler/img_education_60x60_selected.png" v-show="threadCategory==3"/>
                ...
                vm.receiveData.postData(
                    ...
                    function(){
                        if(vm.postData.success) {
                             alert("发布成功");
                              vm.$router.push({path:'/butler',query:{'category':vm.threadCategory}});
                        }else {
