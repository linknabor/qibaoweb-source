<template>
   <div id="word">
        ...
        <div class="category lite-divider">
            <div class="category_main">
                <div class="category_sub_main fl">
                    <router-link :to="{path:'/butler',query:{category:'2'}}" class="categorya">
                        <img class="category_img" src="../../assets/img/butler/img_repair_60x60.png" v-show="category!=2"/>
                        <img class="category_img_hide" src="../../assets/img/butler/img_repair_60x60_selected.png" v-show="category==2"/>
                        <div class="category_txt">报修</div>
                    </router-link>
                </div>

                <div class="category_sub_main fl">
                    <router-link :to="{path:'/butler',query:{category:'0'}}" class="categorya">
                        <img class="category_img" src="../../assets/img/butler/img_education_60x60.png" v-show="category!=0"/>
                        <img class="category_img_hide" src="../../assets/img/butler/img_education_60x60_selected.png" v-show="category==0"/>
                        <div class="category_txt">服务需求</div>
                    </router-link>
                </div>

                <div class="category_sub_main fl">
                    <router-link :to="{path:'/butler',query:{category:'1'}}" class="categorya">
                        <img class="category_img" src="../../assets/img/butler/img_chat_60x60.png" v-show="category!=1"/>
                        <img class="category_img_hide" src="../../assets/img/butler/img_chat_60x60_selected.png" v-show="category==1"/>
        ...
        <div v-show="threads_count==0">
		    <img class="adimg" src="../../assets/img/butler/bg_publish.png"/>
	    </div>
        <!-- 评论  -->
        <div class=" p15 " style="border-bottom: 2px solid #d4cfc8;"  v-for="thread in threads">
            ...
            <div class="fs13" style="color: #a6937c; line-height: 23px; width: 100%;">
                <img style="width: 13px; height: 13px;" src="../../assets/img/butler/icon_time_gray.png"/>&nbsp;{{thread.formattedDateTime}}
                <div class="fr pr15 comment" style="text-align: right;" @click="gotoDetail(thread.threadId)" >
                    <img style="width: 13px; height: 13px;" src="../../assets/img/butler//icon_comment_gray.png"/>&nbsp;{{thread.commentsCount}}
                </div>
            </div>
        </div>
...
export default {
   ...
   methods: {
       ...
       //图片
        ...
        //点击返回
        gotoindex() {
            location.href='https://www.e-shequ.com/qibao/weixin/wuye/index.html?v=20160229#/';
        ...
        publicnew() {
        	...
        	{
               this.$router.push({path:'/publish',query:{'category':vm.$route.query.category}})
        	}
        }
   },
