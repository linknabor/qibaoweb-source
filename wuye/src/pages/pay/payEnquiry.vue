<template>
   <div class="p15 ">
        <div v-show="currentpage =='list'">
            <div class="dropdown-wrap" :class="{collapsed:dropdownCollapsed,coll90:this.startDate=== this.threemonthagos,coll63:this.startDate ==''}" @click="toggleDropdown">
