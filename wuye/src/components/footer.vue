...
.footer_wuye_selected{background-image: url('../assets/img/common/footer_shequ_selected.png');}
.footer_zenzhi{background-image: url('../assets/img/common/footer_zenzhi.png');}
.footer_person{background-image: url('../assets/img/common/footer_wode.png');}
</style>
	...
	<div class="index">
	    <footer class="footer">
		    <nav>
		        <ul>
		        	<li>
			            <a href="https://www.e-shequ.com/qibao/weixin/wuye/index.html" class="nav-controller active">
			              	<i class="footer_logo footer_wuye_selected"></i>社区
			            </a>
			        </li>
			        <!-- <li>
			            <a href="javascript:void(0);" class="nav-controller">
			              <i class="footer_logo footer_zenzhi"></i>社区
			            </a>
			        </li> -->
			        <li>
			            <a href="https://www.e-shequ.com/qibao/weixin/person/index.html" class="nav-controller">
