<template>
   <div class="orders" :class="{orderc:groupsNum==0}">
...
<!--					<span style="color: #888">（共{{order.count}}件商品）</span>-->
			...
			<!-- <a href="#" class="btn-plain fr" ms-visible="order.status==5" ms-click="viewFreight(order)">查看物流</a> -->
				<!--recieved "-->
...
export default {
   ...
   mounted() {
       ...
       this.common.initWechat(['chooseWXPay']) ;
       this.firstALL();
   },
...
.center-bgs {
    background-image: url(../assets/images/bg_orders.png) ;
