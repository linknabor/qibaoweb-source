       ...
       <div class="adorder">
        ...
        <div class="p15 order-item divider" style="height: 60px;" v-if="order.orderType==4">
                ...
                <div class="pt15 fs13" style="line-height:23px; padding-top: 5px;">
                    <a href="#" class="lite-btn fs13 fr" @click="gotoGroupDetail(order)">团购详情</a>
                </div>
            </div>
...
export default {
   ...
   mounted() {
        ...
        // orderId:vm.getUrlParam("orderId")
   ...
   methods: {
       ...
       getTimeStr(){
        ...
        gotoGroupDetail(order){
                window.location.href = "https://www.e-shequ.com/qibao/weixin/group/rgroupinvite.html?ruleId="+ order.groupRuleId + "&share=1";
        }
